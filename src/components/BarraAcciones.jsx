...
const BarraAcciones = ({ botones, onAgregarClick, onEditarClick, onActualizarClick, onImprimirClick, onDescargarClick, onCompartirClick, onFiltrarClick }) => { 
  ...
  return (
    <div style={{ marginBottom: '10px', backgroundColor: '#30394e', padding: '5px', borderRadius: '6px', boxShadow: 'rgba(0, 0, 0, 0.07) 0px 1px 2px, rgba(0, 0, 0, 0.07) 0px 2px 4px, rgba(0, 0, 0, 0.07) 0px 4px 8px, rgba(0, 0, 0, 0.07) 0px 8px 16px, rgba(0, 0, 0, 0.07) 0px 16px 32px, rgba(0, 0, 0, 0.07) 0px 32px 64px' }}>
